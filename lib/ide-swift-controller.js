...
export default class IdeSwiftController {
    ...
    setupToolBar(toolBar) {
        ...
        buttons.play = toolBar.addButton({ icon: 'play', iconset: 'fa', callback: 'ide-swift:debugOrResume', tooltip: 'Debug the target.'});
    ...
    updateToolBar() {
        ...
        if (buttons) {
            ...
            buttons.stop.setEnabled(this.appIsRunning() || this.appIsPaused());
            buttons.over.setEnabled(this.appIsPaused());
            buttons.in.setEnabled(this.appIsPaused());
            buttons.out.setEnabled(this.appIsPaused());

            const playIcon = this.appIsPaused() ? 'play-circle-o' : 'play';
            this.updateIcon(buttons.play, playIcon, 'fa');
        }
    }
